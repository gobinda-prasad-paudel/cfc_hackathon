              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">emergency@womensupport.org</p>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-br from-pink-50 to-green-50 rounded-2xl p-6">
              ...
              <div className="space-y-3 text-sm">
                <div>
                  ...
                  <p className="text-gray-600">
                    We respond to all inquiries within 24 hours, emergency cases
                    immediately.
                  </p>
                </div>
                <div>
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We can connect you with qualified legal professionals in our
                    network.
                  </p>
                </div>
              </div>
