        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-gray-600">Identity Protected</div>
            </div>
            <div className="text-center">
              <div className="flex items-center justify-center mb-2">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-4">
              Your safety and privacy are our top priorities. We keep all victim
              identities completely confidential and provide a secure platform
              for women to seek help, support, and empowerment.
            </p>
          ...
          <div className=" grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4 text-sm">
                "Empowering Women, Protecting Lives, Building Futures"
              </p>
              <p className="text-gray-600 text-sm">
                Dedicated to creating a safer world for women through support,
            ...
            <div>
              ...
              <div className="space-y-3 text-sm">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <p className="text-gray-600">support@thrive.org</p>
                </div>
              </div>
            </div>
